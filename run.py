...
def step_2_pca_kmeans(pca_file_path, dimensions_list, max_k, clustering_script):
    ...
    os.makedirs('./scMCTL-main/scMCTL-main/clustering/output_data', exist_ok=True)
...
if __name__ == "__main__":
    ...
    # Step 1
    preprocessing_script = './scMCTL-main/preprocessing/preprocessing.R'
    output_processed_path = './scMCTL-main/preprocessing/output_data/gene_expression_afterprocess.csv'
    output_variable_genes_path = './scMCTL-main/preprocessing/output_data/gene_expression_2000genes.csv'
    ...
    # D:/GOOGLE_Download/scMCTL-main/preprocessing/input_data/SimCell.csv
    # Step 3
