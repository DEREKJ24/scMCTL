...
if __name__ == "__main__":
    ...
    # Data Load
    input_gene_expression_path = './scMCTL-Pipeline/preprocessing/output_data/gene_expression_afterprocess.csv'
    input_confidence_cells_path = './scMCTL-Pipeline/metaclustering/output_data/TopConfidence_cells.csv'
