...
def main():
    ...
    # Path Configuration
    csv_file_path = './scMCTL-Pipeline/preprocessing/output_data/gene_expression_2000genes.csv'
    result_csv_path = './scMCTL-Pipeline/clustering/output_data/multi_clusts_combined.csv'
